...
void modegen::converters::split_by_version::operator ()(std::vector<modegen::module>& mods)
{
	result.clear();
...
void modegen::converters::split_by_version::split_mod(const modegen::module& mod)
{
	set_base(mod);
...
void modegen::converters::split_by_version::split(const modegen::function& obj)
{
...
void modegen::converters::split_by_version::split(const modegen::enumeration& obj)
{
	auto cur_ver = modegen::get<version>(obj);
	if(!cur_ver) base_mod().content.emplace_back(obj);
	else add_by_version(obj, *cur_ver);
...
void modegen::converters::split_by_version::split(const modegen::record& obj)
{
...
void modegen::converters::split_by_version::split(const modegen::interface& obj)
{
	auto bver = modegen::get<version>(obj);
...
modegen::module& modegen::converters::split_by_version::base_mod()
{
...
const modegen::module& modegen::converters::split_by_version::base_mod() const
{
	assert(0<result.size());
	assert(base_index<result.size());
	return result[base_index];
...
modegen::meta_parameters::version modegen::converters::split_by_version::base_ver() const
{
